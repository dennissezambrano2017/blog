export const blogList = [
    ...
    },
    {
      ...
      category: 'Java',
      subCategory: ['Comunicación', 'Flujos'],
      description: "En general, durante un período de tiempo determinado, los hilos de baja prioridad reciben poco. Los hilos de alta prioridad reciben mucho. Como era de esperar, la cantidad de tiempo de CPU que recibe un hilo tiene un profundo impacto en sus características de ejecución y su interacción con otros hilos que se están ejecutando actualmente en el sistema.",
      description2: "Cuando se inicia un hilo secundario, su configuración de prioridad es igual a la de su hilo principal. Puede cambiar la prioridad de un hilo llamando a setPriority(), que es un miembro de Thread. El nivel especifica la nueva configuración de prioridad para el hilo de llamada. El valor del nivel debe estar dentro del rango MIN_PRIORITY y MAX_PRIORITY. Actualmente, estos valores son 1 y 10, respectivamente. Para devolver un hilo a la prioridad predeterminada, especifique NORM_PRIORITY, que actualmente es 5. Estas prioridades se definen como variables finales estáticas dentro de Thread.",
      description3: "Al usar múltiples hilos, a veces es necesario coordinar las actividades de dos o más. El proceso por el cual esto se logra se llama sincronización (synchronization). La razón más común para la sincronización es cuando dos o más hilos necesitan acceso a un recurso compartido que solo puede ser utilizado por un hilo a la vez. Puede sincronizar el acceso a un método modificándolo con la palabra clave synchronized. Cuando se llama a ese método, el hilo de llamada entra en el monitor del objeto, que luego bloquea el objeto. Si bien la creación de métodos synchronized dentro de las clases que se crean es un medio fácil y efectivo para lograr la sincronización, no funcionará en todos los casos. Por ejemplo, es posible que se desee sincronizar el acceso a algún método que no esté modificado por synchronized. Esto puede ocurrir porque se desea utilizar una clase que no haya creado uno, sino un tercero, y no se tenga acceso al código fuente. Por lo tanto, no es posible agregar synchronized a los métodos apropiados dentro de la clase. ¿Cómo se puede sincronizar el acceso a un objeto de esta clase? Afortunadamente, la solución a este problema es bastante sencilla: simplemente se realizan llamadas a los métodos definidos por esta clase dentro de un bloque synchronized.",
      authorName: 'PAOLA ZAMBRANO',
      authorAvatar: '/assets/images/paola.jpeg',
      createdAt: '31 de julio/2022',
      cover: '/assets/images/Semana10_1.jpg',
      refer: ['http://dis.um.es/~bmoros/Tutorial/parte10/cap10-2.html'],
    ...
    {
      id: 11,
      title: 'Arquitecturas de aplicaciones orientadas a modelos y servicios',
      category: 'Arquitectura',
      subCategory: ['Modelos', 'Servicios'],
      description: "Dentro de las aplicaciones distribuidas, se debe considerar su estructura y comportamiento de los elementos que sean relevantes para satisfacer las necesidades de sus interesados (stakeholders)",
      description2: "Dentro de las aplicaciones distribuidas, se debe considerar su estructura y comportamiento de los elementos que sean relevantes para satisfacer las necesidades de sus interesados (stakeholders), aplicando la toma de decisiones de forma racional y definiendo arquitecturas, entorno, equipos y sistemas. Una arquitectura de aplicación es el conjunto de aspectos comunes a diferentes implementaciones concretas. Para la IEEE, la definición de una arquitectura de aplicación es organización fundamental de un sistema presente en sus componentes, sus relaciones una con la otra, y del entorno siguiendo los principios de su diseño y evolución.",
      description3: "La primera de las arquitecturas mostradas en clase es la orientada a modelos, o MDA (Model-Driven Architecture), considerada un marco arquitectónico abierto y de carácter neutral hacia proveedores que tiene un enfoque principal a estándares OMG asociados a los ciclos de vida del desarrollo de sistemas. El enfoque mencionado conduce a la flexibilidad a largo plazo de las implementaciones del sistema, así como también su integración, el mantenimiento, las pruebas y posteriormente, su simulación dando como resultado la eficiencia de su interportabilidad y reutilización.",
      authorName: 'PAOLA ZAMBRANO',
      authorAvatar: '/assets/images/paola.jpeg',
      createdAt: '31 de julio/2022',
      cover: '/assets/images/Semana11_3.gif',
      refer: ['https://ingenieriadelsoftwareuah2015.wordpress.com/2015/03/23/arquitectura-dirigida-por-modelos-mda/#:~:text=La%20Arquitectura%20Dirigida%20por%20Modelos,de%20varios%20dominios%20y%20tecnolog%C3%ADas.', 'https://picodotdev.github.io/blog-bitix/2020/12/tipos-de-arquitecturas-de-aplicaciones-de-software/', 'https://ieeexplore.ieee.org/document/917550/'],
      imgs1:'/assets/images/Semana11_1.gif',
      imgs2: '/assets/images/Semana11_2.png',
      imgs3:'/assets/images/Semana11_3.gif',
    },
    {
      id: 12,
      title: 'Arquitecturas de aplicaciones orientadas a modelos y servicios (PARTE 2)',
      category: 'Arquitectura',
      subCategory: ['Modelos', 'Servicios'],
      description: "Para definir lo que es un servicio, hay que tener en contexto de que dentro de las arquitecturas existen tareas específicas que establecen ciertos funcionamientos del software",
      description2: "La segunda arquitectura mostrada en clase es la orientada a servicios (SOA por sus siglas en inglés), pero es mejor considerada como un patrón o modelo de diseño de software en donde es posible la reutilización de sus elementos gracias a la presencia de interfaces de servicios que adquieren comunicación entre sí a través de una red que consta de un lenguaje común. Entonces, un servicio se representa como una unidad autónoma de una o más funciones del mismo software.",
      description3: "SOA es la integración de todos los elementos del programa informático que tienen implementaciones y se mantienen por separado, y eso logra que se puedan comunicar entre sí y que puedan trabajar en conjunto para dar luz verde a las aplicaciones de software en diversos sistemas. Los componentes principales de la SOA son cuatro: el primero es el Servicio tal cual, y se clasifican en privados y públicos, acorde a la necesidad del desarrollador o de la empresa, cada servicio tiene tres características principales que son la implementación, los contratos y las interfaces principales. El segundo componente es el Proveedor, es nada más y nada menos que la herramienta que brinda más servicios a una empresa sea de manera propia o externa. El tercer componente es el Consumidor, éste solicita al proveedor un servicio para consumirlo acorde a las reglas del contrato que está en el servicio. Y el último componente es el Registro, que funciona como un archivo histórico de los servicios que han sido utilizados, los consumidores pueden revisar los servicios por medio de su registro.",
      authorName: 'PAOLA ZAMBRANO',
      authorAvatar: '/assets/images/paola.jpeg',
      createdAt: '7 de agosto julio/2022',
      cover: '/assets/images/Semana12_3.png',
      refer: ['https://aws.amazon.com/es/what-is/service-oriented-architecture/ ', 'https://www.redhat.com/es/topics/cloud-native-apps/what-is-service-oriented-architecture', 'https://medium.com/@SoftwareDevelopmentCommunity/what-is-service-oriented-architecture-fa894d11a7ec '],
      imgs1:'/assets/images/Semana12_1.png',
      imgs2: '/assets/images/Semana12_2.png',
      imgs3:'/assets/images/Semana12_3.png',
    },
    {
      id: 13,
      title: 'SOAP y RESTful',
      category: 'Servicios',
      subCategory: ['XML', 'Protocolos'],
      description: "Dentro de la internet, existe la comunicación basada en protocolos conocidos como HTTP, HTTPS, FTP, entre otros; Pero hay un protocolo que es esencial para el funcionamiento de los servicios web",
      description2: "Las interfaces de este pueden hacer el consumo del servicio de un servidor en específico, muchas funcionalidades ampliamente usadas en la red tienen implementaciones basadas en estos servicios, como los buscadores, el comercio en línea y las plataformas multimedia, estamos hablando de los Servicios SOAP. SOAP significa Simple Object Access Protocol, y es la responsable de darle forma que debe adoptar la solicitud de una comunicación entre un Cliente y una API, que luego pasa al Servidor. Basado en lenguaje XML, entonces se trata de un conjunto de detalles que debe tener un documento XML para adquirir una forma adecuada. Dentro de una petición, se encuentra un Envelope (sobre) de SOAP y sus elementos principales que son el Header y el Body, el primero contiene metadatos encriptados de uso opcional, y el segundo, la información de los datos en sí o el cuerpo del mensaje.",
      description3: "Tanto el servicio SOAP como el actualmente preferido por los desarrolladores, el REST, se utilizan para los servicios consumidos en ambientes web, pero tiene procesos distintos, además REST contiene un desarrollo mucho más sencillo de realizar, sin embargo, cuando el desarrollador escoge trabajar con XML, se basará en SOAP, si no, optaría por trabajar con HTTP. En términos de seguridad, SOAP tiene ventaja gracias al anclaje de WS-Security en sus protocolos de red, además consta de un mejor servicio de depuración de errores al tener repetición de solicitudes.",
      authorName: 'PAOLA ZAMBRANO',
      authorAvatar: '/assets/images/paola.jpeg',
      createdAt: '16 de agosto/2022',
      cover: '/assets/images/Semana13_3.jpg',
      refer: ['https://www.ionos.es/digitalguide/paginas-web/desarrollo-web/soap-simple-object-access-protocol/', 'https://www.chakray.com/what-are-the-differences-between-rest-and-soap/ ', 'https://docs.informatica.com/es_es/data-integration/data-services/10-2-hotfix-1/guia-de-servicios-web/servicios-web/diferencias-entre-los-servicios-web-rest-y-soap.html'],
      imgs1:'/assets/images/Semana13_1.png',
      imgs2: '/assets/images/Semana13_2.png',
      imgs3:'/assets/images/Semana13_3.jng',
    },
    {
      id: 14,
      title: 'Arquitectura de aplicaciones - Arquitecturas orientadas a servicios',
      category: 'Java',
      subCategory: ['Comunicación', 'Flujos'],
      description: "La arquitectura orientada a los servicios (SOA) es un tipo de diseño de software que permite reutilizar sus elementos gracias a las interfaces de servicios que se comunican a través de una red con un lenguaje común.",
      description2: "Antes de que se empezara a utilizar la SOA a fines de los noventa, era muy difícil conectar una aplicación con los servicios alojados en otro sistema, y se necesitaba una integración profunda de punto a punto (conectividad, enrutamiento, traducción de los modelos de datos, etc.). Luego, los desarrolladores debían repetir el proceso para cada proyecto nuevo. Este modelo se conocía como monolítico, ya que el código para toda la aplicación formaba parte de una sola implementación. Si algo no funcionaba correctamente, debía darla de baja por completo hasta que se solucionaran los problemas y luego volver a implementarla como una versión nueva.",
      description3: "Los elementos esenciales de la arquitectura orientada a los servicios consisten en tres funciones. 1. Proveedor de servicios: Se encarga de crear servicios web, ofrecerlos a un registro de servicios disponibles y gestionar sus condiciones de uso. 2. Agente o registro de servicios: Se encarga de brindar información acerca del servicio a quien lo solicite, y puede ser público o privado. 3. Usuario del servicio o persona que lo solicita: Buscará un servicio en el registro o por medio del agente, y se conectará con el proveedor para recibirlo.",
      authorName: 'RICARDO TURRIAGO',
      authorAvatar: '/assets/images/turriago.jpg',
      createdAt: '28 de agosto/2022',
      cover: '/assets/images/Semana14_1.jpg',
      refer: ['https://www.hugedomains.com/domain_profile.cfm?d=soaagenda.com', 'https://web.archive.org/web/20100207015506/http://www.sopera.de/en/products/sopera-at-a-glance'],
      imgs1:'/assets/images/Semana14_2.jpg',
      imgs2: '/assets/images/Semana14_3.jpg',
      imgs3:'/assets/images/Semana14_4.jpg',
    },
    {
      id: 15,
      title: 'Arquitectura de aplicaciones - Arquitecturas orientadas a servicios',
      category: 'Java',
      subCategory: ['Comunicación', 'Flujos'],
      description: "Para que los diferentes ordenadores y otros dispositivos con conectividad no caigan en el caos, se atienen a un protocolo de red. SOAP es, junto con REST, uno de los protocolos más importantes de Internet.",
      ...
      description3: "Un servicio Web RESTful es aquel servicio web que está basado en la arquitectura REST. Los servicios Web RESTful se basan en recursos. Un recurso es una entidad, la cual se almacena principalmente en un servidor y el cliente solicita el recurso utilizando servicios Web RESTful. El uso de Servicios Web RESTful mejora la portabilidad entre cualquier tipo de plataforma. Esto permite a los desarrolladores poder escalar las aplicaciones sin gran complicación. La principal ventaja es la separación entre el Cliente y el Servidor, ya que no importa el lenguaje del que proviene o el tipo de Servidor (Python, Java, Node.js); lo único que se necesita es generar correctamente cada solicitud. En futuras entradas se abordarán otros Servicios Web.",
      authorName: 'RICARDO TURRIAGO',
      authorAvatar: '/assets/images/turriago.jpg',
      createdAt: '04 de septiembre/2022',
      cover: '/assets/images/Semana15_1.jpg',
      refer: ['https://www.ibm.com/docs/es/rsas/7.5.0?topic=standards-soap', 'https://aws.amazon.com/es/what-is/restful-api/'],
      imgs1:'/assets/images/Semana15_2.jpg',
      imgs2: '/assets/images/Semana15_3.jpg',
      imgs3:'/assets/images/Semana15_4.jpg',
    },
    {
      id: 16,
      title: 'Arquitectura de aplicaciones - Arquitecturas orientadas a servicios',
      category: 'Java',
      subCategory: ['Comunicación', 'Flujos'],
      description: "SOAP vs Restful. Elegir entre ambas opciones, sigue siendo un reto para algunas empresas que todavía no están familiarizadas con las ventajas de una u de otra.",
      description2: "Ventajas de WebService => Pocas operaciones con muchos recursos; Se centra en la escalabilidad y rendimiento a gran escala para sistemas distribuidos hipermedia; HTTP GET, HTTP POST, HTTP PUT, HTTP DEL; XML auto descriptivo; Síncrono; Comunicación punto a punto y segura. Ventajas SOAP => Muchas operaciones con pocos recursos; Se centra en el diseño de aplicaciones distribuidas; SMTP,HTTP POST, MQ; Tipado fuerte, XML Schema",
      description3: "",
      authorName: 'LIN SALINAS',
      authorAvatar: '/assets/images/salinas.jpeg',
      createdAt: '09 de septiembre/2022',
      cover: '/assets/images/Semana16_1.jpg',
      refer: ['https://www.ibm.com/docs/es/rsas/7.5.0?topic=standards-soap', 'https://aws.amazon.com/es/what-is/restful-api/'],
      imgs1:'/assets/images/Semana16_2.jpg',
      imgs2: '/assets/images/Semana16_3.jpg',
      imgs3:'/assets/images/Semana16_4.jpg',
    },
  ];
